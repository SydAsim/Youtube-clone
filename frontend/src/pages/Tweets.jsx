...
import { getUserTweets, createTweet, updateTweet, deleteTweet } from '../services/tweetService';
...
const Tweets = () => {
  ...
  const handleLikeTweet = async (tweetId) => {
    try {
      ...
      fetchTweets(); // Refresh to get updated like count
    } catch (error) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6">Your Tweets</h1>
