        ...
        <div className="flex gap-2 sm:gap-3">
          ...
          <div className="flex-1 min-w-0">
            <textarea
              ...
              className="w-full bg-white text-black border border-yt-lighter rounded-lg p-3 focus:outline-none focus:border-yt-blue resize-none text-sm sm:text-base placeholder:text-gray-400"
              rows="3"
            />
                  ...
                  {editingTweetId === tweet._id ? (
                    <div>
                      <textarea
                        ...
                        className="w-full bg-white text-black border border-yt-lighter rounded p-3 focus:outline-none focus:border-yt-blue resize-none text-sm sm:text-base"
                        rows="3"
                      />
